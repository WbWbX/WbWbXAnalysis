...
public:
  triggerAnalyzer(){
    binseta_.push_back(-2.4);binseta_.push_back(-1.5);binseta_.push_back(-0.8);binseta_.push_back(0.8);binseta_.push_back(1.5);binseta_.push_back(2.4); // ee standard
...
//   histo1D getCorrelationEta(){return correta_;}
  ...
  scalefactor.writeTGraph("scalefactor_pt incl corrErr",false);
  scalefactor.writeTH1D("TH_scalefactor_pt incl corrErr",false);
