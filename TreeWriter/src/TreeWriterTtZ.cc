...
top::NTMuon TreeWriterTtZ::makeNTMuon(const pat::Muon & muon){
...
top::NTElectron TreeWriterTtZ::makeNTElectron(const pat::Electron & electron){
...
top::NTJet TreeWriterTtZ::makeNTJet(const pat::Jet & jet){
