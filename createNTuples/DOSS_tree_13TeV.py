...
process.PFTree   = cms.EDAnalyzer('TreeWriterTtZ',
                                  ...
                                  keepElecIdOnly = cms.string(opt.electronOptions['idName']),
                                  ...
                                  additionalWeights = cms.vstring(""), #("scaleUp"), #can be any vector of strings, generated by EDProducer: EventWeightMCSystematic
                                  #agrohsje fix  
