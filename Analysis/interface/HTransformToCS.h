...
public:
  ...
  void TransformToCS(ztop::NTGenParticle * neutrino,ztop::NTGenParticle * muon);

  //! call this function once per event.
  void TransformToCS(TLorentzVector neutrino,TLorentzVector muon,const int& mucharge);
