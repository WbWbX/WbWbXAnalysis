...
CPUPROFILE=$1.prof LD_PRELOAD=/afs/desy.de/group/cms/perftool/v2.0/lib/libprofiler.so analyse -c emu -s nominal -o test -b -S -T -i emu_8TeV_config_test.txt -o perfout
