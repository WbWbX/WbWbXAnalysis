...
#include "../Tools/interface/containerUnfolder.h"
#include "../Tools/interface/container1DUnfold.h"
#include "../Tools/interface/containerStackVector.h"
#include "../Tools/interface/containerStack.h"
#include "TString.h"
#include <iostream>
#include "TFile.h"
#include "TTree.h"
...
void unfold(int argc, char* argv[]){
	...
	for(size_t i=0;i<ufsize;i++){
		...
		if(debug)
			std::cout << "unfolding " << data.getName() << std::endl;
