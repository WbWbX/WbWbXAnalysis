...
class TUnfoldBinningV17 : public TNamed {
 ...
 public:
   ...
   enum { MAXDIM=32 };
   const TUnfoldBinningV17 *GetBinLocation(Int_t binTHxx,const char *axisSteering,
 ...
 protected:
   ...
   const TUnfoldBinningV17 *GetBinLocationRecursive(Int_t &offset,const char *axisSteering,
